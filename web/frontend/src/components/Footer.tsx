      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h1 className="text-xl font-bold">Reader Hub</h1>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Sua plataforma definitiva para leitura de mangás online. 
              Descubra, leia e acompanhe seus mangás favoritos.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Ação</a></li>
              ...
              <li><a href="#" className="hover:text-white transition-colors">Fantasia</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Reader Hub. Todos os direitos reservados.
          </p>
